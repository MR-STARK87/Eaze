...
export class Parser {
  ...
  parseStatement() {
    ...
    let node;
    if (this.matchKeyword("set")) node = this.parseSet();
    else if (this.matchKeyword("show") || this.matchKeyword("say")) node = this.parseShow();
    else if (this.matchKeyword("repeat")) node = this.parseRepeat();
    else if (this.matchKeyword("while")) node = this.parseWhile();
    else if (this.matchKeyword("if")) node = this.parseIf();
    else if (this.matchKeyword("ask")) node = this.parseAsk();
    else if (this.matchKeyword("define")) node = this.parseDefine();
    else if (this.matchKeyword("return")) node = this.parseReturn();
    ...
    if (node && !node.loc) {
      node.loc = { line: token.line, column: token.column };
    }
    return node;
  }
